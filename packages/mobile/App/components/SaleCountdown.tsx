...
import {BOLD, FONT} from 'utils/constants';
  ...
  renderDigit = d => {
    ...
    return (
      <View
        ...
        <Text text80 style={[styles.digitTxt, {fontSize: size}, digitTxtStyle]}>
          {d}
        </Text>
      </View>
    );
  ...
  renderLabel = label => {
    ...
    if (label) {
      return (
        <Text
          text90
          style={[styles.timeTxt, {fontSize: size / 1.3}, timeLabelStyle]}>
          {label}
        </Text>
      );
    }
