export function setFilterOption(key: string, value: any, page: 'product' | 'search' | 'searchStock' | 'stock') {
    return {
        type:
            page === 'search'
...
export function setFilterOptions(data: any, page: 'product' | 'search' | 'searchStock' | 'stock') {
    return {
        type:
            page === 'search'
...
export function resetFilter(page: 'product' | 'search' | 'searchStock' | 'stock') {
    return {
        type:
            page === 'search'
                ? RESET_SEARCH_FILTER
...
export const SET_SEARCH_STOCK_FILTER_OPTIONS = 'SET_SEARCH_STOCK_FILTER_OPTIONS';
